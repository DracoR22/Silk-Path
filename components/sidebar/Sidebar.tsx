...
const Sidebar = ({currentUser}: Props) => {
  ...
  return (
    <section className="fixed left-0 top-0 mt-[92px] z-20 flex h-full w-[220px] flex-col justify-between overflow-auto
      pb-5 pt-28 max-md:hidden bg-black border-r border-t border-neutral-900 px-3">
      <div className="flex w-full flex-1 flex-col gap-6 -mt-[70px]">
        ...
        {currentUser && (
          <Link href={`/profile/${currentUser?.id}`} className={cn(`group absolute bottom-[100px] p-2 text-md leading-6 font-semibold
